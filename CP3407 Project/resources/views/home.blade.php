            ...
            <div class="bg-gray-300">
                ...
                <footer class="bg-black">
                    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                            ...
                            <div class="grid grid-cols-2 gap-56 sm:gap sm:grid-cols-3">
                                <div>
                                    ...
                                    <ul class="text-white font-medium">
                                        <li class="mb-2 group">
                                            <a href="/home" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">Home</a>
                                        </li>
                                        <li class="mb-2 group">
                                            <a href="/about" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">About Us</a>
                                        </li>
                                        <li class="group">
                                            <a href="/services" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">Services</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="text-white font-medium">
                                        <li class="mb-2 group">
                                            <a href="/shop" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">Men</a>
                                        </li>
                                        <li class="mb-2 group">
                                            <a href="/shop" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">Women</a>
                                        </li>
                                        <li class="group">
                                            <a href="/shop" class="relative after:content-[''] after:absolute after:w-full after:h-[1px] after:bottom-[-0.25rem] after:bg-white after:left-0 after:scale-x-0 after:origin-bottom-left after:transition-transform after:duration-300 group-hover:after:scale-x-100 after:ease-in-out">Accessoriess</a>
                                        </li>
                                    </ul>
                                </div>
                                <div>
                                    ...
                                    <ul class="text-white font-medium">
                                        ...
                                        <li class="flex gap-4">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                viewBox="0 0 71 72" class="bg-white text-black rounded-full hover:text-white hover:bg-black transition duration-500">
                                        ...
                                        <a href="https://www.facebook.com/">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                viewBox="0 0 71 72" class="bg-white text-black rounded-full hover:bg-black hover:text-white transition duration-500">
                                                <path fill="currentColor"
                                        ...
                                        <a href="https://twitter.com/">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                viewBox="0 0 512 512" class="text-black bg-white  rounded-full p-1 hover:text-white hover:bg-black  transition duration-500">
                                                <path fill="currentColor"
                        ...
                        <hr><div class="mt-6 text-center mx-0">
                            <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://voguevista.com/">Vogue Vista</a>. All Rights Reserved.
                            </span>
                        </div><br>
                </footer>
