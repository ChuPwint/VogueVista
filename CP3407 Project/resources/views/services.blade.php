            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a href="/" class="block py-2 px-3 text-white md:p-0 md:hover:text-gray-400 "
                            >Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/services"
                                class="block py-2 px-3 md:hover:text-gray-400 md:p-0 text-white  md:text-gray-400" aria-current="page" >Services</a>
                        </li>
                        <li>
