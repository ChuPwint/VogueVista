            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                    <ul
                        ...
                        <li>
                            <a href="/" class="block py-2 px-3 text-white md:p-0 md:hover:text-gray-400 ">Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/contactUs"
                                class="block py-2 px-3  md:text-gray-400 md:hover:text-gray-400 md:p-0 text-white aria-current="page">Contact
                                Us</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="w-1/2">
                ...
                <form action="{{ route('contactUs.store') }}" method="POST" class="align-center">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="message" id="message" cols="30" rows="5" placeholder="Type your message..."
                            class="block border border-black w-full h-24 p-2.5" required></textarea>
                    </div>
                    <button type="submit"
                        class="bg-black rounded-full text-l font-medium text-white py-2 px-4 mt-2">Contact Us</button>
                </form>
                <div id="successModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 items-center flex justify-center hidden">
            ...
            <div class="w-full flex justify-center h-[540px] flex-col items-center">
                <div class="text-black text-left w-full md:w-1/2 align-middle grid h-[279px]">
                    ...
                    <div class="flex">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-7 fill-black mr-2 mb-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="flex">
                        <svg class=" w-10 h-10 fill-black mr-1 mt-[-4px] ml-[-4px] mb-4 text-white"
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/">
                        <h1 class="text-2xl font-bold italic whitespace-nowrap text-white align-middle text-center">
                            Vogue Vista</h1>
                    </a>
                </div>
                    ...
                    <div>
                        ...
                        <ul class="text-white font-medium">
                            <li class="mb-2 flex gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="size-5 mt-1 fill-white">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                                </svg>
                            ...
                            <li class="flex gap-2 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="currentColor" class="size-6 fill-white text-black">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                </svg>
